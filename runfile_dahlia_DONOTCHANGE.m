...
datasetPath = "new_datasets/45itokawa_sim/";
img_path = datasetPath+"itokawa_automated_images";%;"mv_bennu/bennu_automated_images_2"];
fov_angle = 0.8;
...
clear cam_pos
[limb_starts, limb_ends, edge_points_bc] = image_to_limbs_lo(img_name, r, fov_angle,CB,sun_pos,ext);
...
axis('equal')
%%
[shapeEndPnts,shapePnts, shapePntNhats] = shape_from_limbs_lo(limb_ends,limb_starts,r, 10,0);
